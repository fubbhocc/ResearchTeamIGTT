package com.siat.researchteamigtt.card;
...
import com.siat.researchteamigtt.R;
...
public final class CardScrollViewActivity extends Activity {
    ...
    private enum Action {
        XING_LEI(R.string.XING_LEI, R.drawable.codemonkey1),
        XIE_YAO_QIN(R.string.XIE_YAO_QIN, R.drawable.codemonkey2),
        WANG_LEI(R.string.WANG_LEI, R.drawable.codemonkey3);
